...
const keys = [
  ...
  "S3_STORAGE_BUCKET",
  "S3_STORAGE_REGION",
  "S3_STORAGE_PUBLIC_BASE_URL",
  "S3_STORAGE_ACCESS_KEY_ID",
  "S3_STORAGE_SECRET_ACCESS_KEY",
  "S3_AVATAR_BUCKET",
  "S3_AVATAR_REGION",
  "S3_AVATAR_PUBLIC_BASE_URL",
  "S3_AVATAR_ACCESS_KEY_ID",
  "S3_AVATAR_SECRET_ACCESS_KEY",
  "SES_REGION",
  "SES_FROM_EMAIL",
  "EVENT_FROM_EMAIL",
  ...
  "SES_CONFIGURATION_EVENTOS",
  "SES_CONFIGURATION_NOTIFICACIONES",
