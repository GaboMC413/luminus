...
export const homeContent = {
  hero: {
    ...
    subtitle: "LUMINUS es una plataforma para explorar personas, expertos, espacios, recursos y herramientas diseñadas para acompañarte en tu camino hacia una vida con más equilibrio, claridad y propósito.",
    primaryCta: {
  ...
  features: {
    ...
    subtitle: "LUMINUS reúne comunidad, expertos, espacios de aprendizaje y herramientas digitales para que puedas explorar, conectar y encontrar acompañamiento de forma más consciente.",
    items: [
      {
  ...
  benefits: {
    ...
    subtitle: "El bienestar no sucede de forma aislada. En LUMINUS puedes encontrar personas, contenidos, expertos y espacios que te ayuden a tomar mejores decisiones, descubrir nuevas perspectivas y sostener tu proceso personal con mayor claridad.",
    items: [
      {
  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        ...
        description: "La mejor alternativa para quienes buscan continuity y un mejor valor anual.",
