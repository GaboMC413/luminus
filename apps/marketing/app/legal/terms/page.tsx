      ...
      <main className="max-w-[800px] mx-auto pt-[110px] md:pt-[140px] pb-12 md:pb-24 px-8">
        ...
        <section className="space-y-10 text-[16px] leading-[1.6]">
          <div className="space-y-4">
            ...
            <p>
              Al acceder y utilizar LUMINUS LATAM, usted acepta estar sujeto a estos Términos y Condiciones. Si no está de acuerdo con alguna parte de estos términos, no podrá utilizar nuestros servicios. LUMINUS es una plataforma diseñada para conectar líderes tecnológicos y expertos en la región de Latinoamérica.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <h2 className="text-[20px] font-jakarta font-bold">4. Propiedad Intelectual</h2>
            <p>
          ...
          <div className="space-y-4">
            <h2 className="text-[20px] font-jakarta font-bold">5. Limitación de Responsabilidad</h2>
            <p>
              LUMINUS proporciona la plataforma "tal cual" y no garantiza que los servicios sean ininterrumpidos o libres de errores. No nos hacemos responsables de las interacciones o acuerdos realizados entre usuarios fuera de nuestra supervisión directa.
            </p>
          </div>

          <div className="space-y-4">
            <h2 className="text-[20px] font-jakarta font-bold">6. Modificaciones</h2>
            <p>
