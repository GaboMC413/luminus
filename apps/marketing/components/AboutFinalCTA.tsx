        ...
        <div className="relative rounded-[2.5rem] bg-gradient-to-tr from-slate-900 to-slate-950 p-8 md:p-16 text-center shadow-2xl overflow-hidden border border-slate-800">
          ...
          <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mb-4">
              ...
              <a
                href="/"
                className="inline-flex items-center justify-center rounded-2xl border border-slate-700 bg-transparent px-8 py-4 text-base font-semibold text-white hover:bg-white/5 hover:border-slate-600 transition-all duration-200"
              >
                Explorar LUMINUS
              </a>
            </div>
