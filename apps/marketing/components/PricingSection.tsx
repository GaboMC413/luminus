          ...
          <div className="bg-white rounded-3xl p-8 md:p-10 flex flex-col justify-between gap-8 shadow-lg border border-slate-200/80 hover:shadow-xl transition-shadow">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3">
                <span className="self-start px-3.5 py-1 bg-black text-white text-xs font-semibold rounded-full uppercase tracking-wider">
                  Membresía Mensual
                </span>
                <div className="flex flex-col gap-1">
                  <h3 className="text-4xl md:text-5xl font-extrabold text-slate-900">
                    USD 5 <span className="text-lg font-normal text-slate-600">/ mes</span>
                  </h3>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between">
                  <span className="px-3.5 py-1 bg-black text-white text-xs font-semibold rounded-full uppercase tracking-wider">
                    Membresía Anual
                  </span>
                ...
                <div className="flex flex-col gap-1">
                  <h3 className="text-4xl md:text-5xl font-extrabold text-slate-900">
                    USD 45 <span className="text-lg font-normal text-slate-600">/ año</span>
                  </h3>
                  <p className="text-sm font-bold text-slate-800 pt-1">
                    Luego de tus primeros 3 meses sin costo.
                  </p>
