  ...
  return (
    <section id={id} className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="relative rounded-3xl border border-slate-200/80 p-8 md:p-16 text-center shadow-soft overflow-hidden highlight-module animate-fadeIn">
          
          {/* Subtle backgrounds */}
          <div className="absolute inset-0 opacity-[0.02] bg-[radial-gradient(#000000_1px,transparent_1px)] [background-size:24px_24px] pointer-events-none" />
          ...
          <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
            {/* Sparkle icon */}
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-black text-[#FF80FC] shadow-soft mb-6">
