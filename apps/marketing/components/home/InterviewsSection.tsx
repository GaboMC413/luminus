        ...
        >
          ...
          {INTERVIEWS.map((item) => (
            <div
              key={item.id}
              data-card
              className="w-[300px] sm:w-[384px] h-[400px] p-4 bg-white rounded-2xl shrink-0 flex flex-col gap-4 border border-slate-200/80 snap-start group"
            >
              ...
              <div className="w-full flex-1 flex flex-col justify-start items-start gap-2">
                ...
                <p className="w-full text-sm font-normal text-slate-700 leading-5 line-clamp-4">
                  {item.description}
                </p>
              </div>
