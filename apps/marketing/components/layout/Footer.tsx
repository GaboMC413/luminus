      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-10 flex flex-col gap-6 md:gap-8">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="https://www.instagram.com/luminus_latam/"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2.5 rounded-xl border border-slate-200 hover:bg-slate-100 text-slate-700 transition-colors"
            ...
            <a
              href="https://www.linkedin.com/in/gabrielmedcap/"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2.5 rounded-xl border border-slate-200 hover:bg-slate-100 text-slate-700 transition-colors"
              aria-label="LinkedIn"
        ...
        {/* Copyright Notice */}
        <p className="text-xs text-slate-500 font-normal text-center w-full mt-4">
          © 2026 LUMINUS Latam.
        </p>
