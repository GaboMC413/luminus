        ...
        <div className="w-full lg:w-5/12 flex flex-col justify-center items-start gap-6 text-left">
          ...
          <div className="pt-2">
            <a
              ...
              className="flex sm:inline-flex items-center justify-center px-8 py-3.5 bg-black hover:bg-slate-800 text-white text-base font-normal rounded-2xl text-center w-full sm:w-auto sm:min-w-[240px] transition-colors"
            >
