...
export function renderEmailLayout({ title = "LUMINUS", contentHtml, alignCenter = true }: EmailLayoutOptions): string {
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; margin: 0; padding: 0; background-color: #ffffff !important; color: #0f172a !important; -webkit-font-smoothing: antialiased;">
  <div style="max-width: 580px; margin: 0 auto; padding: 40px 24px; background-color: #ffffff !important; color: #0f172a !important; text-align: ${containerTextAlign};">
    ...
    <!-- MAIN CONTENT BODY -->
    <div style="text-align: ${containerTextAlign};">
      ${contentHtml}
    </div>
