...
export function renderVivianaNewsletterHtml(options?: {
  ...
  <div style="margin-bottom: 36px;">
    ...
    <p style="font-size: 16px; line-height: 1.6; color: #000000; margin: 0 0 20px 0;">
      El domingo publicamos una nueva entrevista de LUMINUS con Viviana Pagliaroli, profesora de Educación Física e instructora de Pilates con más de 17 años de experiencia. Conversamos sobre pilates y cómo cuidar el cuerpo pensando también en el futuro.
    </p>
    ...
    <p style="font-size: 16px; font-weight: normal; color: #000000; margin: 0 0 16px 0;">
      Estas son solo algunas de las ideas que surgieron durante la charla. Puedes ver la entrevista completa en nuestro canal de YouTube.
    </p>

    <!-- BOTÓN YOUTUBE -->
    <div style="text-align: center; margin-bottom: 12px;">
      <a href="https://youtu.be/2Rjk8jQ7PiU?si=bbFgsvKCbhHcy-Mv" target="_blank" style="display: inline-block; background-color: #000000; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 12px; font-size: 16px; font-weight: normal; text-align: center; border: 0;">
