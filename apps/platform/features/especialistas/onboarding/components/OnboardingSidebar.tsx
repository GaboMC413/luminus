...
export function OnboardingSidebar({
  ...
  return (
    <div className="hidden lg:flex lg:sticky lg:top-[64px] lg:h-[calc(100vh-64px)] lg:w-80 xl:w-96 bg-white border-r border-slate-200/80 shrink-0 flex-col items-center py-12 px-8 z-50 transition-all duration-500 overflow-hidden relative">
